 ...
 * File khởi động ứng dụng NestJS
 *
 * File này cấu hình và khởi động server API với đầy đủ các middleware,
 * guards, interceptors, và các cấu hình bảo mật cần thiết.
 */
