...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Đăng xuất (Revoke Refresh Token)' }),
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Lấy thông tin profile & quyền hạn của tôi' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Trả về thông tin user chi tiết.' }),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Cấp lại token thành công.' }),
    (0, swagger_1.ApiResponse)({
        status: 401,
