...
/**
 * TENANT STYLE PROVIDER
 *
 * Component này cho phép tùy biến giao diện động dựa trên cấu hình của từng Tenant.
 * Giúp hệ thống linh hoạt hơn hẳn so với việc fix cứng CSS.
 */
