...
const MOCK_TESTIMONIALS = [
    { text: "Absolutely love the quality of these furniture pieces. They transformed my living room completely!", author: "Sarah Jenkins", role: "Interior Designer", rating: 5 },
    { text: "Fast shipping and excellent customer service. The product looks exactly as described.", author: "Michael Chen", role: "Homeowner", rating: 5 },
    { text: "Minimalist design at its finest. Highly recommend for anyone looking to upgrade their space.", author: "Emma Watson", role: "Architect", rating: 4 },
];
...
export function TestimonialsBlock({ title, subtitle, items, styles }: TestimonialsBlockProps) {
