...
export function TextBlockSection({ title, content, styles }: TextBlockSectionProps) {
  return (
    <section 
      ...
      >
        {title && (
            <div className="space-y-4">
                <span className="text-[10px] uppercase tracking-[0.2em] text-accent font-medium">Read More</span>
