...
interface BlockStyleControlsProps {
  ...
  onChange: (newStyles: { backgroundColor?: string; textColor?: string }) => void;
}

export function BlockStyleControls({ styles, onChange }: BlockStyleControlsProps) {
  const updateStyle = (key: 'backgroundColor' | 'textColor', value: string | undefined) => {
    onChange({
      ...styles,
      [key]: value,
    });
