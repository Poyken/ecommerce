  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-end">
        <Button onClick={() => setIsCreateOpen(true)} className="rounded-full px-6 shadow-xl shadow-primary/20">
              ...
              <TableRow key={page.id} className="group hover:bg-muted/30 transition-colors">
                ...
                <TableCell>
                  <div className="flex items-center gap-2">
                    ...
                    {page.slug === "/" && (
                        <Badge variant="outline" className="text-[10px] uppercase tracking-tighter bg-emerald-500/5 text-emerald-600 border-emerald-500/20">
                            Home
                        </Badge>
                    )}
                  </div>
                ...
                <TableCell>
                  <Badge 
                    ...
                    className={page.isPublished ? "bg-emerald-500/10 text-emerald-600 border-emerald-500/20" : ""}
                  >
